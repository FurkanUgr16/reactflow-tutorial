...
const triggerNodes: NodeTypeOption[] = [
  {
    ...
    description:
      "Runs the flow on the clicking button. Good for getting started quickly",
    icon: MousePointerIcon,
  },
  {
    type: NodeType.GOOGLE_FORM_TRIGGER,
    label: "Google Form",
    description: "Runs the flow when the google form submitting",
...
const executionNodes: NodeTypeOption[] = [
  ...
  },
  {
    ...
    label: "Open AI",
    description: "Uses Open AI models to generate text",
  ...
  const handleNodeSelect = useCallback(
    (selection: NodeTypeOption) => {
      if (selection.type === "MANUAL_TRIGGER") {
        ...
        const hasManuelTrigger = nodes.some(
